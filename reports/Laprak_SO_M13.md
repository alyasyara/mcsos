...
Alya Syara Shafira (25832073009) : Documentation Engineer
...
|---|---|---|---|---|
| `Meyliza Rosmalia Putri` | `25832072012` | `Koordinator Teknis` |` Merancang arsitektur struktur data inti antarmuka VFS serta mengoordinasikan modul RAMFS backend.` | `include/mcs_vfs.h`, `kernel/vfs/ramfs.c` |
...
| `Nurul Aminatul Aliah` | `25832073013` | `Verification Engineer` |` Merancang skenario unit testing terisolasi serta melakukan verifikasi asersi fungsi operasional VFS.` | `tests/m13_vfs_host_test.c` |
| `Alya Syara Shafira` | `25832073009` | `Documentation Engineer` |` Menyusun dokumen laporan praktikum Markdown dan mencatat riwayat pembersihan log terminal. `| `m13-history.txt` |
...
|---|---:|---|---|
|| `Meyliza Rosmalia Putri` | `25%` | `kernel/vfs/ramfs.c` `| Menjamin integrasi struktur VFS dan backend RAMFS berjalan sinkron.` |
| `Nisrina Amanda Puteri` | `25%` | `Commit file Makefile.m13` |` Menjamin kelancaran otomasi toolchain. `|
| `Nurul Aminatul Aliah` | `25%` | `tests/m13_vfs_host_test.c` |` Memastikan seluruh fungsi operasi berkas lolos uji validasi (PASS).` |
| `Alya Syara Shafira` | `25%` | `m13-history.txt` |` Seluruh rekaman log terminal dan dokumentasi laporan M13 tersusun rapi.` |
---
