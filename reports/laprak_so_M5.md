...
|---|---|---|---|
| `[Nisrina Amanda Puteri]` | `[25832072010]` | `[PTI 1B]` | `[Toolchain Engineer]` |
| `[Meyliza Rosmalia Putri]` | `[(25832072012)]` | `[PTI 1B]` | `[Documentation Engineer]` |
...
| `[Nisrina Amanda Puteri]` | `[25832072010]` | `[Toolchain Engineer]` | `[Mengonfigurasi otomatisasi target build (Makefile), mengintegrasikan assembler nasm, serta memprogram parameter divisor pit_init.]` | `[f0e1d2c
Makefile]` |
...
| `[Meyliza Rosmalia Putri]` | `[25832072012]` | `[Documentation Engineer]` | `[Menyusun peta dokumentasi bagan alur penanganan interupsi, struktur data deskriptor IDT, analisis reliabilitas, dan invariant sistem.]` | `[docs/M5_DESIGN.md]` |
...
| `[Nisrina Amanda Puteri]` | `[25%]` | `[Log commit Makefile, pengujian target build bersih, dan kalkulasi parameter register PIT.]` | `[Menjamin otomatisasi toolchain berjalan lancar dari clean checkout.catatan]` |
...
| `[Meyliza Rosmalia Putri]` | `[25%]` | `[Berkas draf Markdown, deskripsi kegagalan, dan tabel mitigasi invariant sistem.]` | `[Memastikan seluruh laporan memenuhi format kaidah penulisan teknik yang baku.]` |
