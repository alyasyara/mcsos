...
```text
[Alat: AI Assistant
Prompt ringkas: "Format log audit nm, readelf, dan otomasi Makefile M16 ke format pelaporan markdown"
...
|---|---|---|---|---|
|` Alya Syara Shafira` | `25832073009` | `Toolchain Engineer `| `Menyusun target otomatisasi kompilasi host testing, freestanding silang, serta rules validasi asersi biner pada Makefile.` | `tests/m16/Makefile` |
| `Nisrina Amanda Puteri` | `25832072010 `|` Verification Engineer `|` Membuat kerangka file simulasi utama, merancang skenario pengujian unit test transaksi, dan memvalidasi luaran log sukses. `| `m16_mcsfs_journal.c` |
...
| `Nurul Aminatul Aliah` | `25832073013` |` Documentation Engineer` |` Menyusun kelengkapan berkas dokumentasi, merapikan dokumen laporan praktikum Markdown, dan mengelola ekspor riwayat terminal. `| `m15-history-clean.txt` |
...
|---|---:|---|---|
|  `Alya Syara Shafira` | `25%` | `Makefile Target Rules` |` Terlaksana dengan baik `|
|` Nisrina Amanda Puteri `| `25%` | `Core Test Implementation` |` Terlaksana dengan baik` |
|` Meyliza Rosmalia Putri `| `25%` | `Integration Architecture` | `Terlaksana dengan baik `|
|` Nurul Aminatul Aliah` | `25%` | `Markdown Documentation` | `Terlaksana dengan baik` |
