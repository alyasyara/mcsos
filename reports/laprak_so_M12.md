...
| Anggota kelompok | `[Nisrina Amanda Puteri (25832072010) : Documentation Engineer, Meyliza Rosmalia Putri (25832072012) : Verification Engineer, Alya Syara Shafira (25832073009) :  Toolchain Engineer, Nurul Aminatul Aliah (25832073013) :  Koordinator Teknis]` |
...
|---|---|---|---|---|
| `[Nurul Aminatul Aliah]` | `[(25832073013)]` | `[Koordinator Teknis]` | `[Mengimplementasikan logika parser defensif freestanding murni dan perhitungan Process Image Plan pada m11_elf_loader.c.]` | `[c40b1fd / kernel/user/m11_elf_loader.c]` |
| `[Alya Syara Shafira]` | `[(25832073009)]` | `[Toolchain Engineer]` | `[Menyusun arsitektur pembangunan otomatis (Makefile.m11) serta menyelesaikan kendala kegagalan missing separator.]` | `[c40b1fd / Makefile.m11]` |
| `[Meyliza Rosmalia Putri]` | `[25832072012]` | `[Verification Engineer]` | `[Membuat kerangka simulasi biner tiruan (mocking data) dan 9 skenario pengujian unit (host unit test).]` | `[c40b1fd / tests/m11/m11_host_test.c]` |
...
|---|---:|---|---|
| `[Meyliza Rosmalia Putri]` | `[25%]` | `[Git Commit e51a8bb]` | `[Berhasil mengimplementasikan mcs_spinlock_t menggunakan intrinsik __atomic_exchange_n dan mcs_cpu_relax pause x86_64.]` |
| `[Nurul Aminatul Aliah]` | `[25%]` | `[Git Commit 142b9c3]` | `[Berhasil merancang struktur data mcs_mutex_t kooperatif dan menegakkan invariant kepemilikan owner_thread.]` |
| `[Alya Syara Shafira]` | `[25%]` | `[Git Commit 7fa81bc]` | `[Berhasil membangun modul statis Lock-Order Validator (Lockdep) untuk mendeteksi potensi siklus kebuntuan ABBA via class_id.]` |
