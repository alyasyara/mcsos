...
|---|---|---|---|---|
| `Alya Syara Shafira` | `25832073009` | `Koordinator Teknis` | `Mengoordinasikan alur program dan mengonfigurasi build rules `| `Makefile.m15` |
| `Meyliza Rosmalia Putri` | `25832072012` | `Toolchain Engineer` | `Merancang definisi struktur data modul dan pustaka penyimpanan `| `fs/mcsfs1/` |
| `Nisrina Amanda Puteri` | `25832072010` | `Verification Engineer` |` Menyusun unit test-cases mandiri untuk pembuktian keabsahan fungsi `| `tests/m15/` |
| `Nurul Aminatul Aliah` | `25832073013` | `Documentation Engineer` |` Menyusun dokumentasi teknis, laporan markdown, dan ekspor riwayat pengerjaan `| `m15-history.txt` |
...
|---|---:|---|---|
| `Alya Syara Shafira` | `25%` | `Makefile` |` Terlaksana dengan baik` |
| `Meyliza Rosmalia Putri` | `25%` | `Core Source Code` | `Terlaksana dengan baik` |
| `Nisrina Amanda Puteri` | `25%` | `Test Source Code` |` Terlaksana dengan baik` |
| `Nurul Aminatul Aliah` | `25%` | `Laporan Markdown` | `Terlaksana dengan baik `|
---
