...
|---|---|---|---|
| `[Nurul Aminatul Aliah]` | `[(25832073013) ]` | `[1B PTI]` | `[ anggota]` |
...
```text
[```text
Alat: AI Assistant (Model Bahasa Besar)
Prompt ringkas: "Membuat draf template laporan praktikum MCSOS Milestone M8 berdasarkan riwayat terminal history"
Sumber: AI Assistant
Bagian yang dibantu: Penyusunan struktur draf laporan, pemetaan langkah kerja berdasarkan log riwayat terminal history, dan pemformatan tabel Markdown.
...
|---|---|---|
| `[screenshot]`  | `none` | `Praktikum ini tidak menghasilkan output grafis/framebuffer karena berfokus pada logika heap allocator di sisi host (text-based output).` |
...
|---|---|---|---|---|
|  `Meyliza Rosmalia Putri` | `25832072012` | `Koordinator Teknis` | `Mengoordinasikan arsitektur free-list allocator dan logika first-fit.` | `kernel/mm/kmem.c` |
| `Alya Syara Shafira` | `25832073009` | `Toolchain Engineer` | `Mengonfigurasi Makefile, mengelola branch Git, dan setup otomasi audit.` | `Makefile` |
| `Nisrina Amanda Puteri` | `25832072010` | `Verification Engineer` | `Merancang skenario unit test alokasi, dealokasi, dan negative testing hos.` | `tests/test_kmem.c` |
| `Nurul Aminatul Aliah` | `25832073013` | `Documentation Engineer` | `Menyusun skrip validasi kelengkapan berkas serta mengompilasi laporan.` | `scripts/check_m8_kmem.sh`  |
...
|---|---:|---|---|
|  `Meyliza Rosmalia Putri` | `25%` | `kernel/mm/kmem.c` | `Menyelesaikan kode logika penataan memori dinamis.` |
| `Alya Syara Shafira` | `25%` | `Makefile` | `Menyelesaikan manajemen branch dan target build otomatis.` |
| `Nisrina Amanda Puteri` | `25%` | `tests/test_kmem.c` | `Menyelesaikan penulisan suite pengujian terisolasi.` |
| `Nurul Aminatul Aliah` | `25%` | `scripts/check_m8_kmem.sh` | `Menyelesaikan skrip kepatuhan audit dan laporan.`  |
